...
class Blockchain {
    constructor() {
        ...
        this.difficulty = 0; // Number of leading zeros required
...
// // Mining a New Block with Animation
// function mineBlock() {
...
function updateUsersInfo() {
    // userAPublicKeyElement.innerText = blockchain.users['A'].publicKey;
    // userAWalletAmountElement.innerText = blockchain.users['A'].balance;
    // userBPublicKeyElement.innerText = blockchain.users['B'].publicKey;
    // userBWalletAmountElement.innerText = blockchain.users['B'].balance;
    // userCPublicKeyElement.innerText = blockchain.users['C'].publicKey;
...
// // Update the addTransaction, mineBlock, and validateChain functions to call updatePendingTransactionsList
// function addTransaction() {
//     // ...
//     updatePendingTransactionsList();
// }
